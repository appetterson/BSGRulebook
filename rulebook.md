...
#### Finishing a Cylon <span class="noextradeath">execution</span><span class="extradeath">death</span>
...
#### Finishing a human <span class="noextradeath">execution</span><span class="extradeath">death</span>
...
<ol>
  ...
  <li class="exodusloyalty">Add 1 card from the “Not a Cylon” deck to the Loyalty deck, shuffle, and draw 1 new card. If you were playing as Boomer when you <span class="noextradeath">were executed</span><span class="extradeath">died</span>, and the Sleeper Agent phase hasn’t happened yet, draw 1 more Loyalty card.</li>
  <li>Distribute any titles you had when you <span class="noextradeath">were executed</span><span class="extradeath">died</span> to the first in the <a href="#lines-of-succession">line of succession</a>, including your new character. Titles held by other players do not change, even if your new character is higher in the line of succession.</li>
  <li class="daybreak">If the <span class="noextradeath">executed</span><span class="extradeath">dead</span> character was the Mutineer, your new character receives the Mutineer card again, following the instructions on the card as if they just received it face up.</li>
...
<ul>
  <li>Boomer:
    <ul>
      ...
      <li>If after the Sleeper Agent phase, start in the Brig<span class="exodusloyalty"> and draw an additional Loyalty card</span>. <span class="newcaprica">If the <span class="noextradeath">executed</span><span class="extradeath">dead</span> character was on New Caprica, start Boomer in "Detention" instead.</span></li>
    </ul>
  </li>
